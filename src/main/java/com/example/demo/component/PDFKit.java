...
import com.example.demo.component.builder.HeaderFooterBuilder;
import com.example.demo.component.builder.PDFBuilder;
import com.example.demo.exception.PDFException;
...
public class PDFKit {
     ...
     *
     */
    public void exportToFile(String fileName,Object data,OutputStream outputStream){
    ...
    public static String getFontPath() {
        String classpath=PDFKit.class.getClassLoader().getResource("").getPath();
        String fontpath=classpath+"\\static\\fonts";
        return fontpath;
    }
